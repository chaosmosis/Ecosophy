...
> *la moyenne* La moyenne arythmétique d'une série de données est résultante de la sommes des élements de cette séries de nombres divisée par le nombre l'élements de cette somme. La moyenn est très sensible aux valeurs aberrantes.

> *la médiane* la médianne est la valeur que l'on renocntre lorsqu'on divise une série de donnée de nombres en deux ensembles avec des effectfis similaires de telle mani!re à ce que 50% des observation soient au dessus de la médianne et 50% sous elle. La médiane n'est pas influencée par les valeurs abérrantes.

> *le minimum* La plus petite des valeurs d'une série donnée de nombres.

> *le maximum* La valeur la plus élevée rencontée dans une série donnée de nombres.

> *The operational capacity* (capacité oprationnelle ?) corresponds to the number of inmates that a penal institution can actually keep while remaining functional <sup id="a36">[36](#f36)</sup>


> *The design capacity* corresponds to the number of inmates that a penal institution was intended to keep when it was constructed or renewed <sup id="a36">[36](#f36)</sup>
