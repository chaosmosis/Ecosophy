...
<div style="text-align: center"><img src="{{ site.baseurl }}/assets/densitepeni.png" alt="densitepenitentiaire" style="width:475px;" ></div>

Sachant que l’Europe élargie dénombre 82,1 détenus pour 100 places et l’union Européenne 89,5 détenus pour 100 places, il va sans dire que les détenus détenus en Belgique, à l’heure du covid, étaient dans une situation très relativement peu favorables comprativement aux détenus allemands où l’on constate une densité pénitentiaire plus faible que la moyenne de la Grande Europe. 

Comparer la densité pénitentiaire ne se fait pas sans problèmes évdiment. Puisqu'il existe une grande diversité dans la manière dont les établissements pénitentiaires vont déterminer leurs capacité d’accueils, dite aussi capacité.
