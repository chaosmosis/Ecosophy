...
Notons enfin quelques unes des défintions proposées par les membres de l'université de Lausanne en charge du Projet *Space* encadré par le Conseil de L'Europe. Les documents que nous ont gracieusement fournit la DGEPI via le CCSP témoigne de l'usage des distinctions courantes au sein des établissements pénitentiaires des pays membres du Conseil de L'Europe qui s'identiient bien aux défintions données par Tigan et Aebi (2019).
...
Les informations récoltées auprès de la DGEPI nous ont conduit à identifier à la notion de "Capacity" celle de "capacité oprationnelle" dont use l'administration. De même, ce que les experts du conseil de l'europe définissent comme "The operational capacity" correspond, *in concreto*, en Belgique,  aux nombres de détenus présents au jour le jour au sein des EP du pays. Enfin, la défintion de *The design capacity* proposé par le Conseil de l'Europe s'identifie selon nous aux chiffres relatifs aux "capcités théoriques" que l'on retrouve dans les documents de la DGEPI. 

Ceci dit, on peut est à même de reveneir sur deux des indicateurs clefs de notre analyse.
...
Bien entendu, ces chiffres sont trompeurs si on cherche à comparer deux pays entre eux mais aussi une population carcérale d'un même pays à travers le temps. L'un des déterminants essentielle du nombre de détenus dans un système carcérale, étant bien entendu, il s'agit de normaliser les données avec cette éléments. En effet, tout autre chose étant égale par ailleurs, il est assz intuitif de supposer qu'une augmentation de la population sur un territoire donnée devrait conduire à une augmnetation du nombre de détenus.

C'est la raison d'existence d'un indicateur, tel que celui que nous avons défini ci-dessus, l'indicateur de densité carcérale, qui n'est autre que la rapport entre la somme du nombre de détenus "passager" et "condamnés" journalier moyens au sein des prisons du Royaume de Belgique avec avec la population de ce pays. 
